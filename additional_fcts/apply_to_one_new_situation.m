function [list_of_distance, list_of_velocity, pTmp] = apply_to_one_new_situation(s, models, nbData, pTmp)
nb_models = length(models);
list_of_distance = zeros(1, nb_models);
list_of_velocity = zeros(1, nb_models, nbData-1);
new_idx = 1;
if nargin < 4 % generate a random situation
